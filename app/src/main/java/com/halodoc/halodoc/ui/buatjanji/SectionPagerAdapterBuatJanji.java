...
public class SectionPagerAdapterBuatJanji extends FragmentPagerAdapter {

    private static final String[] TAB_TITLES = new String[]{"Dalam Proses", "Selesai"};

    public SectionPagerAdapterBuatJanji(@NonNull @NotNull FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                return new ProgressBuatJanjiFragment();
            case 1:
                return new DoneBuatJanjiFragment();
            default:
